...
![logo](http://ret2ldz.github.io/images/0.png)
...
while True:
    try:
       ...
       io.close()
```
![logo](http://ret2ldz.github.io/images/14.png)
...
直接把/bin/sh\x00写入buffer然后执行execve(buf_addr,0,0)即可
...
![logo](http://ret2ldz.github.io/images/17.png)
...
![logo](http://ret2ldz.github.io/images/18.png)
...
![logo](http://ret2ldz.github.io/images/19.png)
...
主函数逻辑
![logo](http://ret2ldz.github.io/images/21.png)

say()：
![logo](http://ret2ldz.github.io/images/22.png)
...
![logo](http://ret2ldz.github.io/images/23.png)
...
![logo](http://ret2ldz.github.io/images/24.png)

经典菜单题，没有后门函数，所以考虑用onegadget打malloc_hook

![logo](http://ret2ldz.github.io/images/26.png)
